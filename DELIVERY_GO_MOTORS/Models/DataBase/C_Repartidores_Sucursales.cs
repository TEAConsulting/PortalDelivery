...
namespace ZPIDI_PORTAL.Models.DataBase
{
    ...
    public partial class C_Repartidores_Sucursales
    {
        public int id_repa_sucursal { get; set; }
        public int id_usuario { get; set; }
        public string codigo_sucursal_previo { get; set; }
        public string codigo_sucursal { get; set; }
        public int @base { get; set; }
        public int prestamo { get; set; }
        public int activo { get; set; }
        public Nullable<System.DateTime> fecha_registro { get; set; }
        public Nullable<int> id_usuario_movimiento { get; set; }
